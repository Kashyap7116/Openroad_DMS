...
import { generateNewId } from "@/modules/shared/utils/utils";
...
export function MultiStepSaleForm({
  onSubmit,
  onCancel,
  initialData,
  vehicles,
}: MultiStepSaleFormProps) {
  ...
  useEffect(() => {
    if (initialData && initialData.sale_details) {
      ...
      const saleDetailsWithDefaults = {
        ...
        freelancer_commission:
          initialData.sale_details.freelancer_commission ||
          initialFormData.freelancer_commission,
      };
  ...
  useEffect(() => {
    ...
    formData.sale_details.sale_price,
    formData.sale_details.down_payment,
    formData.sale_details.payment_method,
  ]);
  ...
  const handleChange = (
    section: keyof typeof initialFormData | "freelancer_commission",
    field: string,
    value: any
  ) => {
    setFormData((prev) => {
  ...
  const handleFileChange = (
    ...
    section: "buyer" | "documents" | "freelancer_commission",
    fieldName: string,
  ...
  const removeImage = (
    ...
    if (section === "documents" && typeof index === "number") {
      ...
      // Single file
      const file = (formData[section] as any)[fieldName] as
        | FileWithPreview
        | string
        | null;
        ...
        return (
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-2 md:col-span-2">
              <Label htmlFor="vehicle_license">
                Vehicle to Sell <span className="text-destructive">*</span>
              </Label>
              <VehicleSelector
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e) =>
                  handleChange("buyer", "contact", e.target.value)
                }
              />
            </div>
            <div className="space-y-2 md:col-span-2">
              ...
              <Textarea
                ...
                onChange={(e) =>
                  handleChange("buyer", "address", e.target.value)
                }
              />
            </div>
            <div className="space-y-2 md:col-span-2">
              ...
              <FileUpload
                name="buyerIdProof"
                file={formData.buyer.id_proof}
                onFileChange={(e) => handleFileChange(e, "buyer", "id_proof")}
                onRemove={() => removeImage("buyer", "id_proof")}
              />
            </div>
          </div>
        );
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-2">
                ...
                <Input
                  id="salePrice"
                  type="number"
                  value={formData.sale_details.sale_price}
                  onChange={(e) =>
                    handleChange(
                      "sale_details",
                      "sale_price",
              ...
              <div className="space-y-2">
                ...
                <Input
                  id="saleDate"
                  type="date"
                  value={formData.sale_details.sale_date}
                  onChange={(e) =>
                    handleChange("sale_details", "sale_date", e.target.value)
                  }
                />
              </div>
              <div className="space-y-2 md:col-span-2">
                ...
                <Select
                  onValueChange={(value) =>
                    handleChange("sale_details", "payment_method", value)
                  }
                  value={formData.sale_details.payment_method}
                >
                  <SelectTrigger>
                    <SelectValue />
                  </SelectTrigger>
              ...
              <Card className="p-4 bg-muted/50">
                <CardContent className="pt-4 grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    ...
                    <Input
                      id="financeCompany"
                      value={formData.sale_details.finance_company}
                      onChange={(e) =>
                        handleChange(
                          "sale_details",
                          "finance_company",
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      id="down_payment"
                      type="number"
                      value={formData.sale_details.down_payment}
                      onChange={(e) =>
                        handleChange(
                          "sale_details",
                          "down_payment",
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      id="loan_amount"
                      type="number"
                      value={formData.sale_details.loan_amount}
                      readOnly
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      id="loan_tenure"
                      type="number"
                      value={formData.sale_details.loan_tenure}
                      onChange={(e) =>
                        handleChange(
                          "sale_details",
                          "loan_tenure",
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      id="monthly_emi"
                      type="number"
                      value={formData.sale_details.monthly_emi}
                      onChange={(e) =>
                        handleChange(
                          "sale_details",
                          "monthly_emi",
        ...
        return (
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-2">
              ...
              <Input
                id="freelancerName"
                value={formData.freelancer_commission.name}
                onChange={(e) =>
                  handleChange("freelancer_commission", "name", e.target.value)
                }
              />
            </div>
            <div className="space-y-2">
              ...
              <Input
                id="commission"
                type="number"
                value={formData.freelancer_commission.commission}
                onChange={(e) =>
                  handleChange(
                    "freelancer_commission",
                    "commission",
            ...
            <div className="space-y-2 md:col-span-2">
              ...
              <Textarea
                ...
                value={formData.freelancer_commission.address}
                onChange={(e) =>
                  handleChange(
                    "freelancer_commission",
                    "address",
            ...
            <div className="space-y-2 md:col-span-2">
              ...
              <FileUpload
                ...
                file={formData.freelancer_commission.id_proof}
                onFileChange={(e) =>
                  handleFileChange(e, "freelancer_commission", "id_proof")
                }
                onRemove={() =>
                  removeImage("freelancer_commission", "id_proof")
                }
              />
            </div>
          </div>
        ...
        return (
          <div className="space-y-2">
            <Label htmlFor="documents">
              Upload Sales Contract & Other Documents
            </Label>
            <FileUpload
              name="documents"
              files={formData.documents}
              onFileChange={(e) =>
                handleFileChange(e, "documents", "documents", true)
              }
              onRemove={(index) => removeImage("documents", "documents", index)}
              isMultiple
            />
          </div>
        );
      ...
      <div className="flex justify-between pt-4">
        ...
        {currentStep === steps.length - 1 && (
          <Button onClick={handleSubmit}>
            {initialData ? "Update Sale" : "Submit Sale"}
          </Button>
        )}
      </div>
    </div>
...
const ReviewStep = ({
  ...
  formData: Omit<SaleData, "sale_id" | "vehicle_license">;
}) => {
  return (
    <div className="space-y-6">
      <ReviewSection title="Buyer Information">
        ...
        />
        <ReviewItem
          label="Buyer ID Proof"
          value={renderFilePreview(formData.buyer.id_proof, "id_proof")}
        />
      </ReviewSection>
      ...
      <ReviewSection title="Sale & Payment">
        <ReviewItem
          label="Sale Price"
          value={`฿${formData.sale_details.sale_price.toLocaleString()}`}
          isBold
        />
        ...
        {formData.sale_details.payment_method === "Financing" && (
          <>
            ...
            <ReviewItem
              label="Down Payment"
              value={`฿${(
                formData.sale_details.down_payment || 0
              ).toLocaleString()}`}
            />
            <ReviewItem
              label="Loan Amount"
              value={`฿${(
                formData.sale_details.loan_amount || 0
              ).toLocaleString()}`}
            />
            <ReviewItem
              label="Loan Tenure"
              value={`${formData.sale_details.loan_tenure || 0} months`}
            />
            <ReviewItem
              label="Monthly EMI"
              value={`฿${(
                formData.sale_details.monthly_emi || 0
              ).toLocaleString()}`}
            />
          </>
        )}
      ...
      {formData.freelancer_commission &&
        formData.freelancer_commission.name && (
          <ReviewSection title="Freelancer Commission">
            ...
            <ReviewItem
              label="Commission"
              value={`฿${(
                formData.freelancer_commission.commission || 0
              ).toLocaleString()}`}
            />
            <ReviewItem
              label="Address"
            ...
            <ReviewItem
              ...
              value={renderFilePreview(
                formData.freelancer_commission.id_proof,
                "freelancer_id"
              )}
            />
          </ReviewSection>
          ...
          {formData.documents.length > 0 ? (
            formData.documents.map((doc, i) => (
              <ReviewItem
                key={i}
                label={`Document ${i + 1}`}
                value={renderFilePreview(doc, `document_${i + 1}`)}
              />
            ))
          ) : (
