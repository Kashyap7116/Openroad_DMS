...
import {
  ...
  ReviewSection,
  renderFilePreview,
} from "../../shared/components/ui/review-step";
...
export function MultiStepPurchaseForm({
  onSubmit,
  onCancel,
  initialData,
}: MultiStepPurchaseFormProps) {
  ...
  const handleFileChange = (
    ...
    if (isMultiple) {
      ...
      setFormData(
        (prev) =>
          ({
            ...prev,
            [fieldName]: [
              ...(prev[fieldName] as (FileWithPreview | string)[]),
              ...newFiles,
            ],
          } as FormData)
      );
      ...
      setFormData(
        (prev) => ({ ...prev, [fieldName]: fileWithPreview } as FormData)
      );
    }
  };
  ...
  const removeImage = (fieldName: keyof FormData, index?: number) => {
    if (typeof index === "number") {
      ...
      // For single images like mainImage
  ...
  useMemo(() => {
    const { vehiclePrice, taxFee, insuranceFee, deliveryFee, financingPayoff } =
      formData;
    const total =
      vehiclePrice +
      taxFee +
      insuranceFee +
      deliveryFee +
      (formData.paymentType === "Financing Pay-off" ? financingPayoff : 0);
  ...
  useMemo(() => {
    ...
    setFormData((prev) => ({
      ...prev,
      totalDistance: distance > 0 ? distance : 0,
    }));
        ...
        return (
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-2">
              <Label htmlFor="previousLicensePlate">
                Original License Plate (Vehicle ID){" "}
                <span className="text-destructive">*</span>
              </Label>
              <Input
                id="previousLicensePlate"
                value={formData.previousLicensePlate}
            ...
            {showOtherBrandInput && (
              <div className="space-y-2">
                <Label htmlFor="otherBrand">Other Brand Name</Label>
                <Input
                  id="otherBrand"
            ...
            <div className="space-y-2">
              ...
              <Combobox
                ...
                disabled={!formData.brand && !showOtherBrandInput}
              />
            </div>
            {(showOtherModelInput || formData.brand === "other") && (
              <div className="space-y-2">
                <Label htmlFor="otherModel">Other Model Name</Label>
                <Input
                  id="otherModel"
            ...
            <div className="space-y-2">
              ...
              <Input id="vin" value={formData.vin} onChange={handleChange} />
            </div>
            <div className="space-y-2">
              ...
              <div className="flex flex-wrap gap-4 pt-2">
                {fuelTypes.map((item) => (
                  <div key={item.id} className="flex items-center space-x-2">
                    <Checkbox
                      id={item.id}
                      checked={formData.fuelType.includes(item.id)}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-4">
              ...
              >
                ...
                <div className="flex items-center space-x-2">
                  <RadioGroupItem value="Financing Pay-off" id="finance" />
                  <Label htmlFor="finance">Financing Pay-off</Label>
                </div>
              </RadioGroup>
              ...
              {formData.paymentType === "Financing Pay-off" && (
                <div className="space-y-2 pt-4">
                  ...
                  <Input
                    id="financingPayoff"
                    type="number"
                    value={formData.financingPayoff}
            ...
            <div className="space-y-4 rounded-lg bg-gray-50 p-4 border dark:bg-gray-900/50">
              <div className="grid grid-cols-2 gap-x-4 gap-y-2">
                ...
                <Input
                  ...
                  onChange={handleNumberChange}
                />
                <Label htmlFor="taxFee">Tax Fee (฿)</Label>
                <Input
                  id="taxFee"
                  type="number"
                  className="text-right"
                ...
                <Input
                  ...
                  onChange={handleNumberChange}
                />
                <Label htmlFor="deliveryFee">Delivery/Service Fee (฿)</Label>
                <Input
                  id="deliveryFee"
                  type="number"
                  className="text-right"
      ...
      case 2:
        return (
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="space-y-2 md:col-span-2">
              <Label htmlFor="freelancerIdProof">
                Upload Freelancer ID Proof
              </Label>
              <FileUpload
                name="freelancerIdProof"
                file={formData.freelancerIdProof}
                onFileChange={(e) => handleFileChange(e, "freelancerIdProof")}
                onRemove={() => removeImage("freelancerIdProof")}
              />
            </div>
          </div>
        );
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="space-y-2">
              ...
              <FileUpload
                ...
                onFileChange={(e) => handleFileChange(e, "insuranceDoc")}
                onRemove={() => removeImage("insuranceDoc")}
              />
            </div>
            <div className="space-y-2">
              ...
              <FileUpload
                name="taxDoc"
                file={formData.taxDoc}
                onFileChange={(e) => handleFileChange(e, "taxDoc")}
                onRemove={() => removeImage("taxDoc")}
              />
            </div>
          </div>
        );
        ...
        return (
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="space-y-2 md:col-span-2">
              ...
              <FileUpload
                name="sellerIdCard"
                file={formData.sellerIdCard}
                onFileChange={(e) => handleFileChange(e, "sellerIdCard")}
                onRemove={() => removeImage("sellerIdCard")}
              />
            </div>
          </div>
        );
      case 5:
        return (
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div />
            <div className="space-y-2">
              <Label htmlFor="mileageBefore">Mileage Before Trip</Label>
              <Input
                id="mileageBefore"
                type="number"
            ...
            <div className="space-y-2">
              <Label htmlFor="mileageAfter">Mileage After Trip</Label>
              <Input
                id="mileageAfter"
                type="number"
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                readOnly
                className="font-bold bg-gray-100 dark:bg-gray-800"
              />
            </div>
            <div />
            <div className="space-y-2">
          ...
          <div>
            <div className="space-y-2 mb-4">
              ...
              <FileUpload
                ...
                onFileChange={(e) => handleFileChange(e, "mainImage")}
            ...
            <div className="space-y-2">
              ...
              <FileUpload
                ...
                onFileChange={(e) =>
                  handleFileChange(e, "additionalImages", true)
                }
                onRemove={(index) => removeImage("additionalImages", index)}
                isMultiple
                accept="image/*"
              />
            </div>
      ...
      <div className="flex justify-between pt-4">
        ...
        {currentStep === steps.length - 1 && (
          <Button onClick={handleSubmit}>
            {initialData ? "Update Purchase" : "Submit Purchase"}
          </Button>
        )}
      </div>
    </div>
  ...
  return (
    <div className="space-y-6">
      ...
      <ReviewSection title="Pricing">
        ...
        <ReviewItem
          label="Vehicle Price"
          value={`฿${formData.vehiclePrice.toLocaleString()}`}
        />
        <ReviewItem
          label="Tax Fee"
          value={`฿${formData.taxFee.toLocaleString()}`}
        />
        <ReviewItem
          label="Insurance Fee"
          value={`฿${formData.insuranceFee.toLocaleString()}`}
        />
        <ReviewItem
          label="Delivery/Service Fee"
          value={`฿${formData.deliveryFee.toLocaleString()}`}
        />
        {formData.paymentType === "Financing Pay-off" && (
          <ReviewItem
            label="Financing Payoff"
            value={`฿${formData.financingPayoff.toLocaleString()}`}
          />
        )}
        <ReviewItem
          label="Grand Total"
          value={`฿${formData.grandTotal.toLocaleString()}`}
          isBold
        />
      </ReviewSection>
      ...
      <ReviewSection title="Freelancer Commission">
        ...
        <ReviewItem
          ...
          value={`${
            formData.commissionType === "Fixed" ? "฿" : ""
          }${formData.commissionValue.toLocaleString()}${
      ...
      <ReviewSection title="Insurance & Tax">
        ...
        <ReviewItem
          ...
          value={renderFilePreview(formData.insuranceDoc, "insurance_doc")}
        />
        <ReviewItem
          label="Tax Document"
          value={renderFilePreview(formData.taxDoc, "tax_doc")}
        />
      </ReviewSection>
      ...
      <ReviewSection title="Seller Information">
        ...
        <ReviewItem
          ...
          value={renderFilePreview(formData.sellerIdCard, "seller_id.pdf")}
        />
      </ReviewSection>
          ...
          <div className="flex flex-wrap gap-2">
            {formData.additionalImages.length > 0 ? (
              formData.additionalImages.map((file, index) => (
                <div key={index}>
                  {renderFilePreview(file, `additional_${index + 1}.jpg`)}
                </div>
              ))
            ) : (
